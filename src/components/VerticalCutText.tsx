...
export interface VerticalCutTextRef {
  startAnimation: () => void
  reset: () => void
}
...
const VerticalCutText = forwardRef<VerticalCutTextRef, TextProps>(
  (
    {
      children,
      reverse = false,
...
VerticalCutText.displayName = "VerticalCutText"
export default VerticalCutText
