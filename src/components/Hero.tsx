    ...
    <section className='relative'>
        ...
        <div className='relative py-15 w-full text-white md:py-14 lg:py-24 section z-1 bg-black/60 lg:min-h-[calc(100vh-72px)]'>
            <div className='flex flex-col gap-6 max-w-[720px] relative'>
                <h1 className='text-4xl md:text-5xl font-semibold leading-tight tracking-[-4%]'>Engineering the Future, Powered by Technology. Built by Trust</h1>
                <p className='text-xl font-medium leading-tight tracking-[-4%]'>CUEEDACC  is an indigenous Nigerian company, driven by technology in providing Engineering, Procurement, Construction, Onshore and Offshore Installation (EPCI) to various sectors</p>
            ...
            <div className="flex mt-[5.5rem] w-full max-w-[777px] border border-white relative">
                <div className='flex-1 flex flex-col shrink-0 p-2 md:px-6 py-3 md:py-4 leading-tight tracking-[-4%]'>
                ...
                <div className='flex-1 flex flex-col shrink-0 p-2 md:px-6 py-3 md:py-4 leading-tight tracking-[-4%] border-x'>
